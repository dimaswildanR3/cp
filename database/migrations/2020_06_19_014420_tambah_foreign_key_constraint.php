...
class TambahForeignKeyConstraint extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('pesdik', function ($table) {
            $table->foreign('data_wali_murid')
                ->references('id')->on('wali_murid')
                ->onDelete('restrict')->onUpdate('restrict');
        });

        Schema::table('pesdik', function ($table) {
            $table->foreign('data_ayah_kandung')
                ->references('id')->on('wali_murid')
                ->onDelete('restrict')->onUpdate('restrict');
        });
       
        Schema::table('pesdik', function ($table) {
            $table->foreign('data_ibu_kandung')
                ->references('id')->on('wali_murid')
                ->onDelete('restrict')->onUpdate('restrict');
        });
        ...
        Schema::table('transaksi_perpus', function ($table) {
            $table->foreign('anggota_id')
                ->references('id')->on('anggota_perpus')
                ->onDelete('restrict')->onUpdate('restrict');;
        });
        Schema::table('transaksi_perpus', function ($table) {
        ...
        Schema::table('anggota_perpus', function ($table) {
             $table->foreign('users_id')
                ->references('id')->on('users')
                ->onDelete('restrict')->onUpdate('restrict');
        });

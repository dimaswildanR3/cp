...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <span><img src="assets/img/fotos.png" class="foto" style="float:left;width:50%"alt=""></span>
      <h1 style="margin-top:10%;"> Pelatihan KTI
</h1>
      <h2> Kelas Pelatihan Karya Tulis Ilmiah (KTI) Class Program bertujuan untuk membantu Sobat Insans dalam memahami sistematika dan penyusunan Karya Tulis Ilmiah yang akan dibimbing langsung oleh Mentor.
</h2>
  ...
  <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
    <div class="content-box">
      ...
      <div class="content-text">
        <h5>Sistematika Penulisan yang Baik</h5>
        <p>Mendapatkan materi seputar sistematika penulisan yang baik dan benar.</p>
      </div>
    </div>
    <div class="content-box">
      <div class="circle-number">2</div>
      <div class="content-text">
        <h5>Teknik Merumuskan Masalah</h5>
        <p>Mendapatkan materi seputar teknik merumuskan masalah dalam penulisan Karya Tulis Ilmiah.</p>
      </div>
    </div>
    <div class="content-box">
      ...
      <div class="content-text">
        ...
        <p>Mendapatkan materi seputar teknik menentukan metode penelitian dalam Karya Tulis Ilmiah.</p>
      </div>
    </div>
    <div class="content-box">
      <div class="circle-number">4</div>
      <div class="content-text">
        <h5>Teknik dalam Menentukan Landasan Teori yang Tepat</h5>
        <p>Mendapatkan materi seputar teknik menentukan landasan teori yang tepat dalam Karya Tulis Ilmiah.</p>
      </div>
    </div>
  </div>

...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <form action="/produk/{{$Produk->id}}/update" method="POST" enctype="multipart/form-data">
            <h4><i class="nav-icon fas fa-child my-1 btn-sm-1"></i> Edit Data Produk</h4>
            <hr>
            {{csrf_field()}}
            <div class="row">
                <div class="col-md-6">
                    <label for="nama_produk">Nama</label>
                    <input value="{{$Produk->nama_produk}}" name="nama_produk" type="text" class="form-control" id="nama" placeholder="Nama" >
                    <label for="produk">Paket</label>
                    <input value="{{$Produk->produk}}" name="produk" type="text" class="form-control" id="produk" placeholder="produk" >
                    <label for="harga1">Harga untuk di coret</label>
                    <input value="{{$Produk->harga1}}" name="harga1" type="text" class="form-control" id="harga1" placeholder="harga" >
            ...
            <a class="btn btn-danger btn-sm" href="/produk/index" role="button"><i class="fas fa-undo"></i> BATAL</a>
        </form>
    </div>
</section>
@endsection
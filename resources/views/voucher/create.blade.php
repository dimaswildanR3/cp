        ...
        <form action="/voucher/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input value="{{old('discount')}}" name="discount" type="number" class="form-control" id="discount" placeholder="discount" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">

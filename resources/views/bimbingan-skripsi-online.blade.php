...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <span><img src="assets/img/fotos.png" class="foto" style="float:left;width:50%"alt=""></span>
      <h1 style="margin-top:10%;"> Selesaikan skripsimu tepat waktu dengan Bimbingan Skripsi Online (BSO)
</h1>
      <h2> Bimbingan privat online, jam yang fleksibel, dan Mentor yang ahli dibidangnya membantu kamu cepat menyelesaikan skripsi tepat waktu
</h2>
     ...
     <section id="about" class="about section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <!-- <h2>About</h2> -->
          <h3>Bimbingan Skripsi OnlineBimbingan Skripsi Online <span>BSO</span></h3>
  ...
  <div class="col-lg-6 pt-4 pt-lg-0 content d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="100">
    <div class="content-box">
      ...
      <div class="content-text">
        ...
        <p>Sobat Insans akan mendapatkan  pendampingan oleh  Mentor profesional secara privat online dan intensif</p>
      </div>
    </div>
    <div class="content-box">
      ...
      <div class="content-text">
        ...
        <p>Bimbingan Skripsi Online (BSO) Class Program disediakan untuk semua jurusan</p>
      </div>
    </div>
    <div class="content-box">
      <div class="circle-number">3</div>
      <div class="content-text">
        <h5>Jadwal Konsultasi yang Fleksibel</h5>
    ...
    <div class="content-box">
      ...
      <div class="content-text">
        <h5>Dapat Berkonsultasi Langsung dengan Mentor</h5>

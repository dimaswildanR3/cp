        ...
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li class="dropdown"><a style="cursor: pointer;"><span>Produk</span> <i class="bi bi-chevron-down nav-link scrollto active"></i></a>
              ...
              <li class="dropdown"><a style="cursor: pointer;"><span>Workshop</span> <i class="bi bi-chevron-down nav-link scrollto active"></i></a>
                <ul style="border-radius: 15px;">
                  <li><a class="nav-link scrollto" href="kti">KTI</a></li>            
                  <li><a class="nav-link scrollto" href="skripsi">Skripsi</a></li>           
                </ul>
              </li>
              <li class="dropdown"><a style="cursor: pointer;"><span>Creative Class</span> <i class="bi bi-chevron-down nav-link scrollto active"></i></a>
                <ul style="border-radius: 15px;">
              ...
              <button class="remove-item-button">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="login-button">
                        <div class="login-btn"style="margin-bottom:12px;margin-left:10px;"><a href="/login">Login</a></div>
                    </li>
                </ul>
                @endauth
      ...
      const updateCountdown = () => {
        ...
        if (distance < 0) {
            ...
            document.querySelector(".countdown").innerHTML = "Waktu telah berakhir";
        }
      };

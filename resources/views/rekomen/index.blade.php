...
<section class="content card" style="padding: 10px 10px 20px 20px  ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h4><i class="nav-icon fas fa-child my-0 btn-sm-1"></i> Rekomendasi</h3>
                <hr>
            </div>
        </div>
        <div>
                    ...
                    <table class="table table-hover table-head-fixed" id=''>
                        <thead>
                            <tr class="bg-light">
                                ...
                                <th><div style="width:110px;">Description</div></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$rekomen->isi}}</td>
                                <td>{{$rekomen->link}}</td>
                                {{-- <td>{{$rekomen->nama_rekomen}}</td> --}}
                                <td>
                                    @if($rekomen->cover)
                                    {{-- @if( in_array(pathinfo($rekomen->foto, PATHINFO_EXTENSION), ['png', 'jpg', 'JPEG'])) --}}
                                ...
                                <td>
                                    ...
                                    <a href="/rekomen/{{$rekomen->id}}/edit" class="btn btn-primary btn-sm my-1 mr-sm-1"><i class="nav-icon fas fa-pencil-alt"></i> Edit</a>
                                    @if (auth()->user()->role == 'admin')
                                    <a href="/rekomen/{{$rekomen->id}}/delete" class="btn btn-danger btn-sm my-1 mr-sm-1" onclick="return confirm('Hapus Data ?')"><i class="nav-icon fas fa-trash"></i>
                                        Hapus</a>

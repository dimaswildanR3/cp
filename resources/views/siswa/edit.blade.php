        ...
        <form action="/siswa/{{$siswa->id}}/update" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input value="{{$siswa->nis}}" name="nis" type="text" class="form-control" id="nis" placeholder="nis" >
                    ...
                    <input value="{{$siswa->tanggungan}}" name="tanggungan" type="text" class="form-control" id="tanggungan" placeholder="tanggungan" >
                </div>
            </div>
            <hr>
